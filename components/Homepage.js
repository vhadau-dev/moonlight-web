...
export default function Homepage() {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((res) => setUserData(res.data || { balance: "N/A", inventory: [], pets: [] }))
      .catch(() => setUserData({ balance: "N/A", inventory: [], pets: [] }))
        ...
        >
          ...
          {loading ? (
            ...
            <>
              ...
              <p style={{ fontSize: "1.2rem", marginBottom: "10px" }}>
                🎒 Inventory: {userData?.inventory?.length ? userData.inventory.join(", ") : "No items"}
              </p>
              <p style={{ fontSize: "1.2rem", marginBottom: "10px" }}>
                🐾 Pets: {userData?.pets?.length ? userData.pets.join(", ") : "No pets"}
              </p>
            </>
          )}
